...
class DevelopmentApiComposition {
    constructor({
        ...
        apiRepoBranch = "master", apiRepoUser, apiRepoPsw, apiRepoRegistry
    }) {
        ...
        this.apiRepoRegistry = apiRepoRegistry;
    ...
    downloadAPI$(outputDir) {
        ...
        return Rx.Observable.fromPromise(fs.remove(outputDir).then(fs.ensureDir(tmpDir)))
            .mergeMap(() => GitTools.clone$(this.apiRepo, tmpDir, this.apiRepoBranch, this.apiRepoUser, this.apiRepoPsw, this.apiRepoRegistry))
