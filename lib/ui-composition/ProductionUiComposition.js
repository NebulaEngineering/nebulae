...
class ProductionUiComposition {
    constructor({
        ...
        storeType, googleAppCredentials, finalEnvFile = undefined, namespace = 'core',
        ...
        this.finalEnvFile = finalEnvFile;
    ...
    composeUI$() {
        ...
        return Rx.Observable.forkJoin(
            ...
            .mergeMap(([shellPath, mfeSetups, [mfeContentPaths, mfeAssetsPaths]]) => this.buildShell$(shellPath, mfeContentPaths, mfeAssetsPaths, mfeSetups, this.finalEnvFile))
            ;
    }
    ...
    downloadShell$(outputDir) {
        ...
        return GitTools.clone$(this.shellRepo, tmpDir, this.shellRepoBranch, this.shellRepoUser, this.shellRepoPsw)
     ...
     */
    buildShell$(shellPath, mfeContentPaths, mfeAssetsPaths, mfeSetups, finalEnvFile) {
        return this.shell.buildShellProduction$(shellPath, mfeContentPaths, mfeAssetsPaths, mfeSetups, finalEnvFile);
    }
