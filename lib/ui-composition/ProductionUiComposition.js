...
class ProductionUiComposition {
    ...
    composeUI$() {
        ...
        return Rx.Observable.forkJoin(
            ...
            .switchMap(([shellPath, mfeSetups, mfeContentPaths]) => this.buildShell$(shellPath, mfeContentPaths, mfeSetups))
            ;
    }
    ...
    downloadMicroFrontendPackages$() {
        return this.store.downloadMicroFrontendContents$(this.frontEndId);
    }
    ...
    buildShell$(shellPath, mfeContentPaths, mfeSetups) {
        return this.shell.buildShellProduction$(shellPath, mfeContentPaths, mfeSetups);
    }
